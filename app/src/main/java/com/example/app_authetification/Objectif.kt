...
class Objectif: AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val intent = intent
        val THemeId = intent.getIntExtra("themeIdGen", 0)
        val PersId = intent.getIntExtra("IdPer", 0)
        println("Theme Id1: $THemeId ,Id Pers1: $PersId")
...
// Rappel
        ...
        btnSubmit.setOnClickListener {
            ...
            println("Theme Id2: $THemeId ,Id Pers2: $PersId")
...
// Enregistrer les données dans Firebase Firestore
            ...
            ObjCollectionRef
                ...
                .addOnSuccessListener { querySnapshot ->
                    ...
                    val ObjCollectionReference = db.collection("objectif")
                    ObjCollectionReference.add(objectif)
                        .addOnSuccessListener { documentReference ->
                            ...
                            onBackPressed()
                            println("id: $nextObjId ,title: $title,description: $description,dateDebut: $dateDebut,dateFin: $dateFin,rappel: $btn_rappel,Difficulty: $Difficulty,idUs: $PersId,idTh: $THemeId")
