...
class ConsulterObjectifSousTheme : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_consulter_objectif_sous_theme)
        ...
        afficher(documentId)
        val objectifRef = db.collection("objectifSousTheme").document(documentId)
    ...
    fun afficher(documentId:String) {
        ...
        val documentRef = db.collection("objectifSousTheme").document(documentId)
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        when (item.itemId) {
            R.id.action_edit -> {
                ...
                val intent = Intent(this, ModifierObjectifSousTheme::class.java)
